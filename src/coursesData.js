export const coursesData = [
  ...
  {
    name: "Ειδικά Θέματα Επικοινωνιών και Επεξεργασίας Σήματος: Βαθιά Μάθηση",
    code: "ΕΠ22στ",
    ECTS: "4",
    category: "ΠΜ",
    s1: "",
  ...
  {
    name: "Ειδικά Θέματα Υπολογιστικών Συστημάτων και Εφαρμογών: Αξιόπιστα Συστήματα Λογισμικού",
    code: "ΥΣ16β",
    ECTS: "6",
    category: "ΠΜ",
    s1: "",
